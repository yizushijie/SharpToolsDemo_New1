...
namespace Harry.LabTools.LabCommPort
{
	public partial class CSerialPort
	{
		...
		/// 
		/// </summary>
		public override int mCOMMTimeout
		{
			get
			{
		...
		/// 多地址通信
		/// </summary>
		public override bool mCOMMChildAddr
		{
			get
			{
		...
		/// 是不是复合命令
		/// </summary>
		public override bool mCOMMChildCMD
		{
			get
			{
		...
		/// 消息Log信息
		/// </summary>
		public override string mCOMMLogMsg
		{
			get
			{
		...
		/// 使用的时间
		/// </summary>
		public override TimeSpan mCOMMUsedTime
		{
			get
			{
		...
		/// 
		/// </summary>
		public override bool mCOMMFullParam
		{
			get
			{
		...
		/// 每包字节的大小
		/// </summary>
		public override int mCOMMPerPackageMaxSize
		{
			get
			{
