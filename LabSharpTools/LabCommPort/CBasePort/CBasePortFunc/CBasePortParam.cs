...
namespace Harry.LabTools.LabCommPort
{
	public partial class CCommPort : ICommParam
	{
		...
		/// 
		/// </summary>
		public virtual int mCOMMTimeout
		{
			get
			{
				return 200;
		...
		/// 
		/// </summary>
		public virtual bool mCOMMChildAddr
		{
			get
			{
				return false;
		...
		/// 
		/// </summary>
		public virtual bool mCOMMChildCMD
		{
			get
			{
				return false;
		...
		/// 消息信息
		/// </summary>
		public virtual string mCOMMLogMsg
		{
			get
			{
				return null;
		...
		/// 使用的时间
		/// </summary>
		public virtual TimeSpan mCOMMUsedTime
		{
			get
			{
				return new TimeSpan();
		...
		/// 
		/// </summary>
		public virtual bool mCOMMFullParam
		{
			get
			{
				return false;
		...
		/// 每包字节的大小
		/// </summary>
		public virtual int mCOMMPerPackageMaxSize
		{
			get
			{
				return 64;
		...
		public virtual int mFirstCMDIndex
		{
			get
			{
				if (this.mCOMMPerPackageMaxSize > 0xFF)
				{
					return 3;
				}
				else
		...
		public virtual void  AnalyseParam( int perPackageSize,CSerialPortParam serialParam,CUSBPortParam usbParam,bool isUpAddrID=false)
		{
			...
			this.mCOMMPerPackageMaxSize = perPackageSize;
		}
